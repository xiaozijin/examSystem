package com.demo.examSystem.controller.studentController;

import com.demo.examSystem.Utils.EmailUtil;
import com.demo.examSystem.Utils.MobilePhoneUtil;
import com.demo.examSystem.Utils.ServerResponse;
...
public class StudentSystemController {
    /*
        包含：学号查信息，登录注册找回密码，密码修改，个人信息修改，退出登录
     */
    @Autowired
